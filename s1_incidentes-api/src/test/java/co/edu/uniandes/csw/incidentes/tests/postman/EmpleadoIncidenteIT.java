...
/**
 * Pruebas de integracion de empleado-incidente
 *
 * @author Julian Jaimes
 */
@RunWith(Arquillian.class)
public class EmpleadoIncidenteIT {

    private static final String COLLECTION = "EmpleadoIncidenteResourceTest.postman_collection";
