...
/**
 * Pruebas de logica de la relacion Coordinador - Incidentes
 * @author Juan Camilo Castiblanco
 */
@RunWith(Arquillian.class)
public class CoordinadorIncidenteLogicTest {

    private PodamFactory factory = new PodamFactoryImpl();

    @Inject
    CoordinadorLogic coordinadorLogic;

    @Inject
    CoordinadorIncidenteLogic coordinadorIncidenteLogic;
    ...
    /**
     * Prueba para asociar un Incidente existente a un Coordinador.
     */
    @Test
    public void addIncidenteTest() {
        CoordinadorEntity entity = data.get(0);
        IncidenteEntity incidenteEntity = incidentesData.get(1);
        IncidenteEntity response = coordinadorIncidenteLogic.addIncidente(incidenteEntity.getId(), entity.getId());
    ...
    public void getIncidentesTest() {
        List<IncidenteEntity> list = coordinadorIncidenteLogic.getIncidentes(data.get(0).getId());
    ...
    public void getIncidenteTest() throws BusinessLogicException {
        ...
        IncidenteEntity response = coordinadorIncidenteLogic.getIncidente(entity.getId(), incidenteEntity.getId());
     ...
     /**
     * Prueba para obtener una instancia de Incidente asociada a una instancia
     * Coordinador que no le pertenece.
     *
     * @throws BusinessLogicException
     */
